<%@ page import="com.YangFanou.dao.IcategoryDao" %>
<%@ page import="com.YangFanou.dao.CategoryDao" %>
...
<section id="cart_items">
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						...
						<%
							com.YangFanou.model.Product p = (com.YangFanou.model.Product) pageContext.findAttribute("p");
